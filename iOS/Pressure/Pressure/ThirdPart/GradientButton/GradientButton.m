...
- (void)useSimpleOrangeStyle
{
	...
	UIColor *color = [UIColor colorWithRed:0xff/256.0f green:0x83/256.0f blue:0x02/256.0f alpha:1.0];
	[colors addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:0xf9/255.0f green:0x9c/255.0f blue:0x32/255.0f alpha:1.0];
	[colors addObject:(id)[color CGColor]];
    self.strokeColor = [UIColor colorWithRed:0xed/255.0f green:0x70/255.0f blue:0x14/255.0f alpha:1.0];
    self.normalGradientColors = colors;
    self.normalGradientLocations = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:0.0f],
                                    [NSNumber numberWithFloat:1.0f],
	...
	color = [UIColor colorWithRed:0xf9/255.0f green:0x9c/255.0f blue:0x32/255.0f alpha:1.0];//[UIColor colorWithRed:0.914 green:0.309 blue:0.0 alpha:1.0];
	//[colors2 addObject:(id)[color CGColor]];
	//color = [UIColor colorWithRed:0.935 green:0.4 blue:0.0 alpha:1.0];
	[colors2 addObject:(id)[color CGColor]];
	color = [UIColor colorWithRed:0xff/255.0f green:0x83/255.0f blue:0x02/255.0f alpha:1.0];//[UIColor colorWithRed:0.946 green:0.441 blue:0.01 alpha:1.0];
	[colors2 addObject:(id)[color CGColor]];
    self.highlightGradientColors = colors2;
    self.highlightGradientLocations = [NSMutableArray arrayWithObjects:
                                       [NSNumber numberWithFloat:0.0f],
...
- (void)drawRect:(CGRect)rect 
{
    ...
    point = CGPointMake((self.bounds.size.width / 2.0), self.bounds.size.height-0.5);
	point2 = CGPointMake((self.bounds.size.width / 2.0), 0.0);
	CGContextDrawLinearGradient(context, gradient, point, point2, (kCGGradientDrawsBeforeStartLocation));
